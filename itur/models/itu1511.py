...
class __ITU1511():
    ...
    * P.1511-2 (08/19) (Superseded)
    * P.1511-3 (08/24) (Current version)
    """
...
class _ITU1511_3_():
    ...
    of the Earth are provided on a 0.05° grid in both latitude and longitude.
    ...
    def __init__(self):
        ...
        self.link = 'https://www.itu.int/rec/R-REC-P.1511/' +\
                    'recommendation.asp?lang=en&parent=R-REC-P.1511-3-202408-I'

        self._altitude = None
        self._wgs4_altitude = None
    
    def altitude(self, lat, lon):
        # only the Toographic height changed from v2 to v3
    ...
    def wgs4_altitude(self, lat, lon):
        # none of these files changed from v2 to v3
